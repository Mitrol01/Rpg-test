...
public class PlayerInventory : MonoBehaviour
{
    ...
    public CharachterMotor CharachterMotor;
    ...
    void Start()
    {
        ...
        CharachterMotor = gameObject.GetComponent<CharachterMotor>();
    ...
    {
        if (!CharachterMotor.IsDead)
        {


            // pdv=pdv-((armor*damage)/100)
    ...
    public void Dead()
    {
        //desactive les mvt si mort
        CharachterMotor.IsDead = true;

        PlayerAnimation.Play("die");
        //Debug   .Log("IAihaihiehleh lihsedf ds: " + Time.time);
    }
